...
type Plugin interface {
	...
	Handle(prompt string, context map[string]interface{}) (*models.Analysis, error)
}
...
func (p *CrashLoopPlugin) Handle(prompt string, context map[string]interface{}) (*models.Analysis, error) {
...
func (p *NetworkPlugin) Handle(prompt string, context map[string]interface{}) (*models.Analysis, error) {
	analysis := &models.Analysis{
		Query:      prompt,
		Confidence: 0.75,
		Severity:   "Medium",
